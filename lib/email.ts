import { emailFrom, resendApiKey } from "@/constants";
...
export async function sendPriceDropAlert(userEmail: string, product: Product, oldPrice: number, newPrice: number) {
    try {
...
<html>
    ...
    <body style="
        ...
        ">
            ...
            ">
                <p>
                    You're receiving this email because you're tracking this product on
                    Price Tracker.
                </p>
        ...
        console.log("Couldn't Send Email Resend error", error);
        return { error };
    }
}